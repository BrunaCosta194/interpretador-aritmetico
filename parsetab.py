...
_lr_productions = [
  ...
  ('expression -> expression PLUS term','expression',3,'p_expression_plus','interpretador.py',49),
  ('expression -> expression MINUS term','expression',3,'p_expression_minus','interpretador.py',53),
  ('expression -> term','expression',1,'p_expression_term','interpretador.py',57),
  ('term -> term TIMES factor','term',3,'p_term_times','interpretador.py',61),
  ('term -> term DIVIDE factor','term',3,'p_term_divide','interpretador.py',65),
  ('term -> factor','term',1,'p_term_factor','interpretador.py',73),
  ('factor -> NUMBER','factor',1,'p_factor_number','interpretador.py',77),
  ('factor -> LPAREN expression RPAREN','factor',3,'p_factor_paren','interpretador.py',81),
]
